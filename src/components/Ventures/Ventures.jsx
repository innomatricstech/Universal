...
const Ventures = () => {
  const ventures = [
    {
      id: 1,
      name: 'Universal Builders & Developers',
      description:
        'Specializing in residential and commercial construction, focusing on high-quality apartments, villas, and plotted site developments.',
      image: '/images/fenix-builders.jpeg',
      link: '/ventures#builders'
    },
    {
      id: 2,
      name: 'Universal Exports & Imports',
      description:
        'Currently exporting premium quality rice to Saudi Arabia, expanding to other international markets and exploring new product categories.',
      image: '/images/fenix-exports.jpeg',
      link: '/ventures#exports'
    },
    {
      id: 3,
      name: 'Universal Interior Solutions',
      description:
        'Complete end-to-end interior design and execution service provider for residential and commercial spaces.',
      image: '/images/fenix-interior.jpeg',
      link: '/ventures#interior'
    },
    {
      id: 4,
      name: 'Universal Multi Trading',
      description:
        'Engaged in TMT Steel Trading, with vision to diversify into various commodities and trading opportunities.',
      image: '/images/fenix-multitrading.jpeg',
      link: '/ventures#trading'
    },
      ...
      <div className="container">
        ...
        <div className="ventures-cta text-center mt-4 no-scroll-animate">
          ...
          <div className="cta-actions">
            ...
            <Button variant="primary" size="large" as={Link} to="/ventures">
              View All Ventures
            </Button>
          </div>
        </div>
